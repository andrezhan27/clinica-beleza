...
export function Results() {
  ...
  const cases = [
    { title: language === "pt" ? "Olhar rejuvenescido" : "Rejuvenated eye area", detail: language === "pt" ? "Protocolo personalizado" : "Personalised protocol", image: "/images/before-1-cropped.webp" },
    { title: language === "pt" ? "Harmonia facial" : "Facial harmony", detail: language === "pt" ? "Plano individual" : "Individual plan", image: "/images/before-2-cropped.webp" },
    { title: language === "pt" ? "Textura e luminosidade" : "Texture and radiance", detail: language === "pt" ? "Evolução da pele" : "Skin progress", image: "/images/before-3-cropped.webp" },
  ];
