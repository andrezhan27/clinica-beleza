...
const pt = {
  ...
  testimonials: { eyebrow: "Experiência de quem nos visita", title: "Cuidado que se sente, confiança que permanece.", reviews: "Referência Google Reviews · conteúdo demonstrativo", items: [
    { quote: "O acompanhamento foi excecional desde a primeira consulta. Senti que cada decisão foi explicada com clareza e sem pressa.", name: "Marta C." },
    { quote: "Uma equipa muito atenta e profissional. O resultado ficou delicado, natural e exatamente como esperava.", name: "Inês F." },
    { quote: "O espaço transmite tranquilidade e o plano foi realmente pensado para mim. Recomendo pela confiança e pelo cuidado.", name: "Ana R." },
  ] },
  ...
  location: { eyebrow: "Saldanha · Lisboa", title: "No centro da cidade, perto de si.", address: "Av. João Crisóstomo 63 A, 1050-126 Lisboa", phone: "+351 210 000 000", email: "geral@clinicabeleza.pt", hoursLabel: "Horário", hours: "Segunda a sexta · 09:00–19:00", directions: "Obter direções", booking: "Marcar avaliação", map: "Mapa da localização da Clínica Beleza em Saldanha" },
  ...
  footer: { copy: "Medicina estética, beleza e bem-estar com uma abordagem clínica, personalizada e responsável.", navigation: "Navegação", contact: "Contacto", social: "Acompanhe-nos", privacy: "Privacidade", cookies: "Cookies", terms: "Termos", rights: "© 2026 Clínica Beleza. Todos os direitos reservados." },
};
...
const en: typeof pt = {
  ...
  testimonials: { eyebrow: "Patient experience", title: "Care you can feel. Trust that lasts.", reviews: "Google Reviews reference · demonstration content", items: [
    { quote: "The care was exceptional from the first consultation. Every decision was explained clearly and without rushing.", name: "Marta C." },
    { quote: "A very attentive and professional team. The result was delicate, natural and exactly what I hoped for.", name: "Inês F." },
    { quote: "The space feels calm and the plan was genuinely designed for me. I recommend them for their care and trust.", name: "Ana R." },
  ] },
  ...
  location: { eyebrow: "Saldanha · Lisbon", title: "In the centre of the city, close to you.", address: "Av. João Crisóstomo 63 A, 1050-126 Lisbon", phone: "+351 210 000 000", email: "geral@clinicabeleza.pt", hoursLabel: "Hours", hours: "Monday to Friday · 9am–7pm", directions: "Get directions", booking: "Book assessment", map: "Map showing Clínica Beleza in Saldanha" },
  ...
  footer: { copy: "Aesthetic medicine, beauty and wellbeing with a clinical, personalised and responsible approach.", navigation: "Navigation", contact: "Contact", social: "Follow us", privacy: "Privacy", cookies: "Cookies", terms: "Terms", rights: "© 2026 Clínica Beleza. All rights reserved." },
};
